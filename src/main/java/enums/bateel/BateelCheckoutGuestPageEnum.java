...
public enum BateelCheckoutGuestPageEnum {
	...
	BATEEL_GUEST_FNAME_ENUM_NAME("firstname"), BATEEL_GUEST_LNAME_ENUM_NAME("lastname"),
	BATEEL_GUEST_STREET_ENUM_NAME("street[0]"),
	BATEEL_GUEST_CITY_ENUM_XPATH("//input[@class='input-text' and @name='city']"),
	BATEEL_GUEST_COUNTRY_ENUM_NAME("country_id"), BATEEL_GUEST_POSTCODE_ENUM_NAME("postcode"),
	BATEEL_GUEST_STATE_ENUM_NAME("region_id"), BATEEL_GUEST_TELEPHONE_ENUM_NAME("telephone"),
	BATEEL_GUEST_AGREE_ENUM_NAME("international_disclaimer"), BATEEL_GUEST_TRACKEMAIL_ENUM_ID("guest-email"),
